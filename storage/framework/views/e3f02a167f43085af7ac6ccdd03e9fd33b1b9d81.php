					...
					<table class="table table-bordered table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td><?php echo e($ncc->name_supplier); ?></td>
									<td><img src="images/hangsanxuat/<?php echo e($ncc->image); ?>" width="50px" height="50px;"></td>
									<td><?php echo substr($ncc['description'],0,150)?>...</td>
									<td class="center"><a href="admin/hangsanxuat/edit/<?php echo e($ncc->id); ?>"><i class="icon icon-pencil"></i> Edit</a></td>
									<td class="center"><a href="admin/hangsanxuat/delete/<?php echo e($ncc->id); ?>"><i class="icon icon-bin"></i> Delete</a></td>
								</tr>
