      ...
      <div class="row">
        <div class="col-lg-2 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3><?php echo e(count($sanpham)); ?></h3>
        ...
        <div class="col-lg-2 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3><?php echo e(count($danhmuc)); ?></h3>
        ...
        <div class="col-lg-2 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3><?php echo e(count($customer)); ?></h3>
        ...
        <div class="col-lg-2 col-xs-6">
          ...
          <div class="small-box bg-danger">
            <div class="inner">
              <h3><?php echo e(count($supplier)); ?></h3>
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  ...
                  <div class="progress-group">
                    ...
                    <span class="progress-number"><?php echo e(count($bill)); ?></span>

                    <div class="progress sm">
                      <div class="progress-bar progress-bar-aqua" style="width: <?php echo e(count($bill)); ?>%"></div>
                    </div>
                  </div>
                  ...
                  <div class="progress-group">
                    ...
                    <span class="progress-number"><?php echo e(count($bill2)); ?></span>

                    <div class="progress sm">
                      <div class="progress-bar progress-bar-green" style="width: <?php echo e(count($bill2)); ?>%"></div>
                    </div>
                  </div>
                  <!-- /.progress-group -->
                  <div class="progress-group">
                    <span class="progress-text">Hóa đơn đang chờ xử lý</span>
                    <span class="progress-number"><?php echo e(count($bill1)); ?></span>

                    <div class="progress sm">
                      <div class="progress-bar progress-bar-yellow" style="width: <?php echo e(count($bill1)); ?>%"></div>
                    </div>
                  </div>
                   <!-- /.progress-group -->
                  <div class="progress-group">
                    <span class="progress-text">Hóa đơn đã hủy</span>
                    <span class="progress-number"><?php echo e(count($bill3)); ?></span>

                    <div class="progress sm">
                      <div class="progress-bar progress-bar-red" style="width: <?php echo e(count($bill3)); ?>%"></div>
                    </div>
                  </div>
