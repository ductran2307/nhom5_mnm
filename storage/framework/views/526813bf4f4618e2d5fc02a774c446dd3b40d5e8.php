            ...
            <div class="container">
                <div class="banner_text">
                    ...
                    <ul>
                        ...
                        <li><a href="<?php echo e(route('danhmucsp',$loai_sp->id)); ?>"><?php echo e($loai_sp->name); ?></a></li>
                    </ul>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-lg-3">
                        <div class="product_left_sidebar">
                            ...
                            <aside class="left_sidebar p_catgories_widget">
                                ...
                                <ul class="list_style">
                                    <?php $__currentLoopData = $danhmuc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
