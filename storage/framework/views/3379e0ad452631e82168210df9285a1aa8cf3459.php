              ...
              <div class="col-sm-7">
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <input type="text" name="phone" class="form-control" placeholder="Nhập số điện thoại" value="<?php echo e($supplier->phone); ?>">
                </div>
                <div class="form-group">
                  <label>Email</label>
                  <input type="text" name="email" class="form-control" placeholder="Nhập email" value="<?php echo e($supplier->email); ?>">
                </div>
