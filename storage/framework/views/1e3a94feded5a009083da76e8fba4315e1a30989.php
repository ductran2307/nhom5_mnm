                ...
                <div class="container">
                    <div class="breadcrumb-content">
                        <ul>
                            ...
                            <li class="active"><?php echo e($sanpham->name); ?></li>
                        </ul>
                    </div>
                </div>
            </div>
                           ...
                           <!-- Product Details Left -->
                            <div class="product-details-left">
                                <div class="product-details-images slider-navigation-1">
                                    <div class="lg-image">
                                        <img src="images/product/<?php echo e($sanpham->image); ?>" alt="product image">
                                    </div>
                                </div>
                                <div class="product-details-thumbs slider-thumbs-1">
                                    <div class="sm-image"><img src="images/product/<?php echo e($sanpham->image); ?>" alt="product image thumb"></div>
                                </div>
                            </div>
                            <!--// Product Details Left -->
                        </div>
                                ...
                                <div class="product-info">
                                   ...
                                   <!--  <span class="product-details-ref">Reference: demo_15</span> -->
                                    ...
                                    <div class="price-box pt-20">
                                            ...
                                            <span class="old-price"><?php echo e(number_format($sanpham->unit_price)); ?> VND</span>  
                                          <?php endif; ?>
                                    </div>
                                    ...
                                    <div class="single-add-to-cart">
                                        <form action="<?php echo e(route('themgiohang',$sanpham->id)); ?>" class="cart-quantity">
                                            <div class="quantity">
