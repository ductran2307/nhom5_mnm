        ...
        <div class="box">
	    	...
	    	<?php endif; ?>
					<table class="table table-bordered table-striped">
							...
							<tbody>
								<?php $__currentLoopData = $customer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kh): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>	
								<tr>
									...
									<td class="center"><a href="admin/khachhang/edit/<?php echo e($kh->id); ?>"><i class="icon icon-pencil"></i> Edit</a></td>
									<td class="center"><a href="admin/khachhang/delete/<?php echo e($kh->id); ?>"><i class="icon icon-bin"></i> Delete</a></td>
								</tr>
              ...
              <div class="row">
	      			...
	      			<div class="col-sm-7"><?php echo e($customer->links()); ?></div>
               </div>
				<!-- /task manager table -->
