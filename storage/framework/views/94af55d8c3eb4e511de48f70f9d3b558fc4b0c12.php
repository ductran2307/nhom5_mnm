...
<style type="text/css">
  ...
  <div class="card-body">
  	<?php if(Auth::check()): ?>
    <h4 class="card-title"><?php echo e(Auth::user()->full_name); ?></h4>
    <?php endif; ?>
    ...
    <!-- <a href="#" class="btn btn-primary">See Profile</a> -->
        ...
        <table class="table m-auto">
          <tr>
          	<?php if(Auth::check()): ?>
            <td colspan="2"><p>Họ và tên: </p><h4 id="ho"><?php echo e(Auth::user()->full_name); ?></h4></td>
            <?php endif; ?>
          </tr>
          <tr>
          	<?php if(Auth::check()): ?>
            <td colspan="2"><p>Tên đăng nhập:</p><h4 id="tdn"><?php echo e(Auth::user()->email); ?></h4></td>
            <?php endif; ?>
          </tr>
          <tr>
          	<?php if(Auth::check()): ?>
            <td colspan="2"><p>Địa chỉ:</p><h4 id="diachi"><?php echo e(Auth::user()->address); ?></h4></td>
            <?php endif; ?>
          </tr>
          <tr>
          	<?php if(Auth::check()): ?>
            <td colspan="2"><p>SĐT:</p><h4 id="sdt"><?php echo e(Auth::user()->phone); ?></h4></td>
             <?php endif; ?>
          </tr>
          <tr>
