	...
	<!-- MAIN -->
				<div id="main" class="col-md-9">
					...
					<div id="store">
						<!-- row -->
						<div class="row">
							<?php $__currentLoopData = $sp_sale; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<!-- Product Single -->
							<div class="col-md-4 col-sm-6 col-xs-6" style="height: 500px;">
								<div class="product product-single">
									<div class="product-thumb">
										...
										<button class="main-btn quick-view"><a href="<?php echo e(route('chitietsanpham',$sale->id)); ?>"><i class="fa fa-search-plus"></i> view detail</a></button>
										<img src="source/image/product/<?php echo e($sale->image); ?>" alt="" height="250px">
									</div>
									<div class="product-body">
										<h3 class="product-price">
										<?php if($sale->promotion_price!=0): ?>
										<span class="product-old-price"><?php echo e(number_format($sale->promotion_price)); ?> VND</span><br>
										<del class="product-price" style="font-size: 10px;"><?php echo e(number_format($sale->unit_price)); ?> VND</del>
										<?php else: ?>
										<span class="product-old-price" style="font-size: 18px;"><?php echo e(number_format($sale->unit_price)); ?> VND</span><br><br>
										<?php endif; ?>
									</h3>
										<div class="product-rating">
											<i class="fa fa-star"></i>
										...
										<h2 class="product-name" style="font-size: 14px;"><a href="<?php echo e(route('chitietsanpham',$sale->id)); ?>"><?php echo e($sale->name); ?></a></h2>
										<div class="product-btns">
											<button class="main-btn icon-btn"><i class="fa fa-heart"></i></button>
											<button class="main-btn icon-btn"><i class="fa fa-exchange"></i></button>
											<a href="<?php echo e(route('themgiohang',$sale->id)); ?>"><button class="primary-btn add-to-cart"><i class="fa fa-shopping-cart"></i> Thêm vào giỏ hàng</button></a>
										</div>
									</div>
								</div>
							</div>
						...
						<!-- /row -->
						<div class="row"><?php echo e($sp_sale->links()); ?></div>
					</div>
					<!-- /STORE -->
				</div>
				<!-- /MAIN -->
