<?php $__env->startSection('content'); ?>
    ...
    <div class="box-body" style="width: 1500px;">
	    	...
	    	<?php endif; ?>
         <form role="form" action="admin/hangsanxuat/edit/<?php echo e($supplier->id); ?>" method="post">
              ...
              <div class="col-sm-7">
                ...
                <div class="form-group">
                  ...
                  <img src="images/hangsanxuat/<?php echo e($supplier->image); ?>" width="100px" height="100px">
                  <input type="file" name="image" value="<?php echo e($supplier->image); ?>">
                </div>
                 <div class="form-group">
                  <label>Mô tả</label>
