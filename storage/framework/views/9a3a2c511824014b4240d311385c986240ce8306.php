            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="ncc" id="ncc">
                    <?php $__currentLoopData = $nhacc1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ncc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option 
                      <?php if($product->id_ncc == $ncc->id): ?>
                      <?php echo e("selected"); ?>

                      <?php endif; ?>
                      value="<?php echo e($ncc->id); ?>"><?php echo e($ncc->name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
                </div>
                <div class="form-group">
                  <label>Mô Tả</label>
                  <textarea id="demo" class="form-control ckeditor" name="des" rows="3" placeholder="Mô tả" ><?php echo e($product->description); ?></textarea>
                </div>
                  </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label>Thông số sản phẩm</label>
                   <textarea id="demo" class="form-control ckeditor" name="parameter" rows="3" placeholder="Thông số kỹ thuật" ><?php echo e($product->Parameter); ?></textarea>
                </div>
                <div class="form-group">
                  <label>Xuất xứ</label>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="guarantee">
                    <option value="6" <?php if($product->guarantee == 6): ?> <?php echo e("selected"); ?> <?php endif; ?> /> 6 tháng</option>
                    <option value="12" <?php if($product->guarantee == 12): ?> <?php echo e("selected"); ?> <?php endif; ?> /> 12 tháng</option>
                    <option value="24" <?php if($product->guarantee == 24): ?> <?php echo e("selected"); ?> <?php endif; ?> /> 24 tháng</option>
                  </select>
                </div>
                <div class="form-group">
                  <label>giá gốc</label>
                ...
                <div class="form-group">
                  ...
                  <img src="images/product/<?php echo e($product->image); ?>" width="100px" height="100px">
